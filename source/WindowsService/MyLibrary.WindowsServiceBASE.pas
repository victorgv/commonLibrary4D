unit MyLibrary.WindowsServiceBASE;

interface

uses Vcl.SvcMgr, Vcl.Forms, Winapi.Windows,System.SysUtils,System.Classes, System.JSON;

type
  TLogMessageProcedure = procedure(const p_Message: String) of object;

type
  TMyLibrary_ServiceImplementationBASE = Class(TThread)
  private
...
constructor TMyLibrary_ServiceImplementationBASE.Create(p_LogMessage: TLogMessageProcedure);
begin
  _Service := NIL;
...
procedure TMyLibrary_ServiceImplementationBASE.ServiceExecute;
begin
  Start;
end;
...
procedure TMyLibrary_ServiceImplementationBASE.ServiceStop;
begin
  Terminate;
end;
...
procedure TMyLibrary_ServiceImplementationBASE.ProcesarMensajes;
begin
...
procedure TMyLibrary_ServiceImplementationBASE.sendEventToLogMessage(const p_message: String; p_EventType: DWord);
var
  v_type: String;
begin
...
destructor TMyLibrary_ServiceImplementationBASE.Destroy;
var
  i: integer;
begin
  _ACTIVO := FALSE;
...
function TMyLibrary_ServiceImplementationBASE.TestApplicationTerminated: boolean;
begin
...
procedure TMyLibrary_ServiceImplementationBASE.Execute;
begin
  //
